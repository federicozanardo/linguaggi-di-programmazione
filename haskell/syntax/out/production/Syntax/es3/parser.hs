...
happyExpList = Happy_Data_Array.listArray (0,40) ([32768,1,8196,0,30,0,24,6144,24576,32768,1,6,24,96,0,0,1536,6144,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_calc","Exp","if","then","else","'else if'","while","'='","'+='","'+'","'-'","'*'","'/'","int","var","%eof"]
        bit_start = st * 18
        bit_end = (st + 1) * 18
...
happyReduction_1 (HappyAbsSyn4  happy_var_3)
	...
	(HappyTerminal (TokenId happy_var_1))
	 =  HappyAbsSyn4
		 (\p -> Asse (Leaf happy_var_1) (happy_var_3 p)
	)
...
happyReduction_2 (HappyAbsSyn4  happy_var_3)
	...
	(HappyTerminal (TokenId happy_var_1))
	 =  HappyAbsSyn4
		 (\p -> AssInc (Leaf happy_var_1) (happy_var_3 p)
	)
...
happyReduction_4 (HappyAbsSyn4  happy_var_3)
	...
	(HappyAbsSyn4  happy_var_1)
	 =  HappyAbsSyn4
		 (\p -> Diff (happy_var_1 p) (happy_var_3 p)
	)
